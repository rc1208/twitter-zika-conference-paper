...
class StdOutListener(StreamListener):
    ...
    def on_data(self, data):
        with open("tweet-infected-and-death.txt",'a') as f:
            f.write(data)
        print(data)
        return True
...
if __name__ == '__main__':
    ...
    stream.filter(languages = ["en"],track=['zika spread','zika spreading','zika infect','zika infection','zika death','zika deaths','zika casualty','zika casualties','zika kill','zika kills'])
